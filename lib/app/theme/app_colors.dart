...
class AppColors {
  ...
  // ============== Seller Theme Colors (Green) ==============
  /// Primary Green for Seller Dashboard
  static const Color sellerPrimary = Color(0xFF00C462);

  /// Darker Green for gradients/pressed
  static const Color sellerPrimaryDark = Color(0xFF00964B);

  /// Light Green for backgrounds
  static const Color sellerPrimaryLight = Color(0xFFE6F9F0);
  ...
  /// Seller gradient - Green shades
  static const LinearGradient sellerGradient = LinearGradient(
    colors: [Color(0xFF00C462), Color(0xFF00964B)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
